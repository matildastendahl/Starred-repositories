...
table.c-table tbody {
  box-shadow: inset 1px 0 0 0 var(--_c-table-border-color), inset -1px 0 0 0 var(--_c-table-border-color), inset 0 1px 0 0 var(--_c-table-border-color), inset 0 -1px 0 0 var(--_c-table-border-color);
...
table.c-table tfoot td c-pagination {
  flex: 1;
}
table.c-table th,
table.c-table td {
...
table.c-table--mobile tbody {
  box-shadow: none;
}
table.c-table--mobile tbody tr {
  border-radius: 4px;
  /* Safari box shadow replacement */
...
table.c-table--mobile thead {
  display: none;
}
table.c-table--mobile td {
  display: grid;
  gap: 4px;
  padding: 12px;
  min-height: 62px;
}
table.c-table--mobile td::before {
  font-size: 14px;
  color: var(--_c-table-header-text-color);
...
table.c-table--mobile td:nth-of-type(even) {
