...
.c-progress {
  ...
  box-shadow: 0 0 0 var(--_c-progress-bar-border-width) var(--_c-progress-bar-background-color);
  flex-basis: 100%;
  height: calc(var(--_c-progress-bar-height) - var(--_c-progress-bar-border-width) * 2);
  margin: var(--_c-progress-bar-border-width);
  opacity: 0.75;
  overflow: hidden;
  transform: translateZ(0);
  width: calc(100% - var(--_c-progress-bar-border-width) * 2);
