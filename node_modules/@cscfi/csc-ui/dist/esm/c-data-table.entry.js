...
const CDataTable = class {
  ...
  _renderCellChildren(options, index, key, data) {
    return options.children.map((child) => {
      ...
      return !!Tag ? (h(Tag, Object.assign({}, params, (!(params === null || params === void 0 ? void 0 : params.onClick)
        ? {}
        : {
          onClick: (event) => {
            params.onClick({
        ...
        })), !!((_c = child.children) === null || _c === void 0 ? void 0 : _c.length)
