...
const CTab = class {
  ...
  render() {
    ...
    return (index.h(index.Host, Object.assign({}, a11y, { id: this.hostId, "data-value": this.value, class: classes, onClick: this._onClick }), index.h("span", null, index.h("slot", null)), index.h("c-ripple", { ref: (el) => (this._rippleElement = el) })));
  }
