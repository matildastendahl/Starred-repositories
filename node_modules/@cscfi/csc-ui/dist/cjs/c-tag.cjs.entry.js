...
const CTag = class {
  ...
  render() {
    ...
    return (index.h(index.Host, Object.assign({}, hostParams, { class: hostClasses }), index.h("slot", null), this.closeable && (index.h("c-icon-button", { onClick: () => this._onClose() }, index.h("c-icon", { size: 16, path: mdi.mdiClose })))));
  }
};
CTag.style = cTagCss;
