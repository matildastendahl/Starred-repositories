...
const CSlider = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { class: classes, style: styles }, !!this.label && (index.h("label", { class: "c-slider__label" }, !!this.label && this.label)), index.h("div", { class: "c-slider__wrapper" }, !this.disableTooltip && (index.h("div", { class: "c-slider__tooltip-wrapper", "aria-hidden": "true" }, index.h("span", { "data-tooltip": `${this._formatNumber(+this.value)}${this.unit}` }))), index.h("input", { ref: (el) => (this._inputElement = el), "aria-label": this.ariaLabel || this.label, "aria-valuenow": this.value, "aria-valuetext": `${this.value}${this.unit}`, "aria-valuemin": this.min, "aria-valuemax": this.max, type: "range", name: this.hostName, id: this.hostId || `c-slider__${CSlider._uniqueId}`, min: this.min, max: this.max, step: this.step, disabled: this.disabled, onInput: (event) => this._onInput(event) })), index.h("div", { class: {
        'c-slider__ticks': true,
        'c-slider__ticks--disabled': this.disabled,
      }, "aria-hidden": "true" }, this.tickPositions.map((position) => (index.h("span", { class: {
...
CSlider._uniqueId = 0;
CSlider.style = cSliderCss;

exports.c_slider = CSlider;

//# sourceMappingURL=c-slider.cjs.entry.js.map