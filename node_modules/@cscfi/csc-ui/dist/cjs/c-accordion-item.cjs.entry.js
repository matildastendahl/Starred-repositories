...
const CAccordionItem = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("details", { id: `panel__${CAccordionItem._uniqueId}`, ref: (el) => (this._accordionElement = el), class: accordionClasses, open: !!this.expanded }, index.h("summary", { ref: (el) => (this._accordionHeader = el), class: headerClasses, onClick: (event) => this._onToggleAccordion(event) }, this.hasIcon && (index.h("div", { class: "c-accordion-item__icon", "aria-visible": "hidden" }, index.h("slot", { name: "icon" }))), this.hasCustomHeader && index.h("slot", { name: "header" }), !this.hasCustomHeader && (index.h("div", { class: "c-accordion-item__title" }, this.heading)), index.h("div", { class: indicatorClasses }, index.h("c-icon", { path: mdi.mdiChevronRight, class: { expanded: this.expanded } }))), index.h("div", { ref: (el) => (this._accordionContent = el), class: "c-accordion-item__content-wrapper" }, index.h("div", { class: "c-accordion-item__content", role: "region", "aria-labelledby": `header__${CAccordionItem._uniqueId}` }, index.h("slot", null))))));
  }
