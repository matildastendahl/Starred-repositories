...
import { q as mdiArrowLeft, p as mdiArrowRight } from './mdi.js';
...
const CTabs$1 = proxyCustomElement(class CTabs extends HTMLElement {
  ...
  static get style() { return cTabsCss; }
    ...
    "isMobile": [32],
    "scrollOffset": [32]
  }, [[1, "tabFocus", "tabFocusHandler"], [1, "tabChange", "tabChangeHandler"], [2, "keydown", "handleKeyDown"], [2, "keyup", "handleKeyUp"]], {
    "justify": ["onJustificationChange"],
    "value": ["onExternalValueChange"],
    "scrollOffset": ["onScrollOffsetChange"]
  }]);
...
function defineCustomElement$1() {
  ...
  const components = ["c-tabs", "c-badge", "c-icon", "c-icon-button", "c-ripple", "c-spinner"];
